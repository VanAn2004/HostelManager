...
// Sample data for the rental properties
const rentalProperties = [
  {
    id: 1,
    title: 'Nhà trọ số 416/11/7 Dương Quảng Hàm',
    price: '4 triệu/tháng',
    size: '20m²',
  ...
  {
    id: 2,
    title: 'Nhà trọ số 182 Lê Xuân Oai',
  ...
  {
    id: 3,
    title: 'Nhà trọ số 23-25 Chợ Lớn, Phường 11',
    price: '3.9 triệu/tháng',
    size: '20m²',
    type: 'Nhà trọ, phòng trọ',
    location: 'Quận 6, Thành phố Hồ Chí Minh',
    hasReview: true,
    image: '/api/placeholder/400/250'
  },
  {
    id: 4,
    title: 'Nhà Trọ Nữ Hẻm 30/4, Hưng Lợi',
    price: '2 triệu/tháng',
    size: '27m²',
    type: 'Nhà trọ, phòng trọ',
    location: 'Ninh Kiều, Thành phố Cần Thơ',
    hasReview: false,
    image: '/api/placeholder/400/250'
  },
  {
    id: 5,
    title: 'Nhà Trọ Đường Tạ Quang Bửu',
    price: '4 triệu/tháng',
    size: '30m²',
    type: 'Nhà trọ, phòng trọ',
...
// Hot Listings Section Component
const HotListingsSection = () => {
  return (
    <section className="py-8 container mx-auto px-4">
      <h2 className="text-2xl font-bold text-blue-700 mb-6">LỰA CHỌN CHỖ Ở HOT</h2>
