// Navigation Item Component with improved onClick handling
export default function NavItem({ icon, label, active = false, sidebarOpen, onClick }) {
  return (
    <div 
      className={`flex items-center py-3 px-3 rounded-lg cursor-pointer transition-all duration-150 ${
        active 
